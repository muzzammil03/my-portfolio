...
const Hero = ({ isDarkMode }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="block lg:hidden w-full h-[230px] bg-[#6c4ced] absolute top-0 left-0 z-[1]"></div>
        <div className="hidden lg:block absolute top-0 left-0 w-1/3 h-full bg-[#6c4ced] z-[9]"></div>
